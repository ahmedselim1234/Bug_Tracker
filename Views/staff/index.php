            ...
            <div class="layout-page">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small class="text-muted"><?php echo $_SESSION["userRole"] ?>
                                                    </small>
                                                </div>
                                            </div>
                                        </a>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <h5 class="card-header"> Staff Page
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            foreach ($products as $product) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="badge bg-label-primary me-1"><?php echo $product["category"] ?></span>
                                                    </td>
                                                    <td>
                        ...
                        if ($deleteMsg == true) {
                            ?>
                            <div data-delay="2000"
                                class="bs-toast toast  fade toast-placement-ex bottom-0 start-50 translate-middle-x show bg-info"
